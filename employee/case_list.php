...
<?php 
  ...
  $query_case = "SELECT c.*,u.u_name,u.u_lastname,s.status_name,u.tel,u.email FROM tbl_case as c INNER JOIN tbl_login as u ON c.user_id = u.user_id INNER JOIN tbl_status as s ON 
